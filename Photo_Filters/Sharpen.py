...
def sharpen(input_folder,output_folder):
    ...
    for image in images:
        ...
        image_file = image_file.filter(ImageFilter.SHARPEN)
        # saving image to output folder
        image_file.save(opts.output_folder + '/' + 'sharpen.png')
...
if __name__ == "__main__":
    ...
    sharpen(input_folder,output_folder)