...
def winter(input_folder,output_folder):
    ...
    for image in images:
        ...
        image_file[:, :, 0] = gamma_function(image_file[:, :, 0], 1.25)
        image_file[:, :, 2] = gamma_function(image_file[:, :, 2], 0.75)
        ...
        cv2.imwrite(str(opts.output_folder + '/' + 'winter.png'), image_file)
        cv2.waitKey(0)
...
if __name__ == "__main__":
    ...
    winter(input_folder,output_folder)
