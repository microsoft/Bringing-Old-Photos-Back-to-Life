...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--url", type=str, default="/home/jingliao/ziyuwan/celebrities", help="input"
    )
    parser.add_argument(
        "--save_url",
        type=str,
        default="/home/jingliao/ziyuwan/celebrities_detected_face_reid",
        help="output",
    )
    ...
    for x in os.listdir(url):
        ...
        if len(faces) > 0:
            for face_id in range(len(faces)):
                ...
                io.imsave(
                    os.path.join(save_url, img_name + ".png"),
